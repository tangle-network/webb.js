  ...
  export interface AugmentedSubmittables<ApiType> {
    merkle: {
      ...
      verify: AugmentedSubmittable<
        ...
        [GroupId, ScalarData, Vec<ITuple<[bool, ScalarData]>>]
      >;
    };
    mixer: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      ...
      withdraw: AugmentedSubmittable<
        (
          ...
          cachedRoot: ScalarData | string | Uint8Array,
          comms: Vec<Commitment> | (Commitment | string | Uint8Array)[],
          nullifierHash: ScalarData | string | Uint8Array,
          proofBytes: Bytes | string | Uint8Array,
          leafIndexCommitments: Vec<Commitment> | (Commitment | string | Uint8Array)[],
          proofCommitments: Vec<Commitment> | (Commitment | string | Uint8Array)[]
        ) => SubmittableExtrinsic<ApiType>,
        [GroupId, BlockNumber, ScalarData, Vec<Commitment>, ScalarData, Bytes, Vec<Commitment>, Vec<Commitment>]
      >;
    };
  }
