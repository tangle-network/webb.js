...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    merkle: {
      ...
      addMembers: AugmentedSubmittable<(groupId: GroupId | AnyNumber | Uint8Array, members: Vec<Data> | (Data | { None: any } | { Raw: any } | { BlakeTwo256: any } | { Sha256: any } | { Keccak256: any } | { ShaThree256: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [GroupId, Vec<Data>]>;
      ...
      forceSetManager: AugmentedSubmittable<(groupId: GroupId | AnyNumber | Uint8Array, newManager: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [GroupId, AccountId]>;
       ...
       * logic.
       **/
      verify: AugmentedSubmittable<(groupId: GroupId | AnyNumber | Uint8Array, leaf: Data | { None: any } | { Raw: any } | { BlakeTwo256: any } | { Sha256: any } | { Keccak256: any } | { ShaThree256: any } | string | Uint8Array, path: Vec<ITuple<[bool, Data]>> | ([bool | boolean | Uint8Array, Data | { None: any } | { Raw: any } | { BlakeTwo256: any } | { Sha256: any } | { Keccak256: any } | { ShaThree256: any } | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>, [GroupId, Data, Vec<ITuple<[bool, Data]>>]>;
    };
    mixer: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
