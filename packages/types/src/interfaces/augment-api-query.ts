...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    merkle: {
       ...
       **/
      cachedRoots: AugmentedQueryDoubleMap<ApiType, (key1: BlockNumber | AnyNumber | Uint8Array, key2: GroupId | AnyNumber | Uint8Array) => Observable<Vec<Data>>, [BlockNumber, GroupId]> & QueryableStorageEntry<ApiType, [BlockNumber, GroupId]>;
      /**
       ...
       **/
      usedNullifiers: AugmentedQuery<ApiType, (arg: ITuple<[GroupId, Data]> | [GroupId | AnyNumber | Uint8Array, Data | { None: any } | { Raw: any } | { BlakeTwo256: any } | { Sha256: any } | { Keccak256: any } | { ShaThree256: any } | string | Uint8Array]) => Observable<bool>, [ITuple<[GroupId, Data]>]> & QueryableStorageEntry<ApiType, [ITuple<[GroupId, Data]>]>;
    };
    mixer: {
      [key: string]: QueryableStorageEntry<ApiType>;
