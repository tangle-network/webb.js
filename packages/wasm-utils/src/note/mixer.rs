...
use arkworks_circuits::setup::mixer::{LeafWithPrivateRaw_x5_5, setup_leaf_with_privates_raw_x5_5, setup_leaf_x5_5, Leaf_x5_5};
...
pub fn get_leaf_with_private_raw(
	...
	exponentiation: i8,
	raw: &[u8],
) -> Result<LeafWithPrivateRaw_x5_5, OpStatusCode> {
	if raw.len() < 64 {
