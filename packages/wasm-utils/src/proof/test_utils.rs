...
pub const MIXER_NOTE_X5_5:&str = "webb://v2:mixer/2:3/2:?curve=Bn254&width=5&exp=5&hf=Poseidon&backend=Arkworks&token=EDG&denom=18&amount=0";
pub const ANCHOR_NOTE_X5_4:&str = "webb://v2:anchor/2:3/2:?curve=Bn254&width=5&exp=5&hf=Poseidon&backend=Arkworks&token=EDG&denom=18&amount=0";
